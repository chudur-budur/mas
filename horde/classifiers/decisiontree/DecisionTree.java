...
public class DecisionTree extends Classifier
{
	...
	transient PruningAlgorithm pruningAlgo = null ;

	public void setPruningAlgorithm(PruningAlgorithm pa)
	{
		pruningAlgo = pa;
	}
	...
	public DecisionTree(PruningAlgorithm pa)
	{
		super();
		setPruningAlgorithm(pa);
	}
	...
	{
		System.err.println("--- DecisionTree.learn()");
		root = Node.learn(domain, examples, Integer.MAX_VALUE, random);

		if (this.pruningAlgo != null)
		{
			System.err.println("--- DecisionTree.learn(): pruning ...");
			this.pruningAlgo.gatherTrainingStats(this, examples, random);
			// the original PEP implementation
			this.pruningAlgo.pruneTree(this);
			this.pruningAlgo.deleteTrainingStats(this);

			/** Depth Limited PEP process -- added by khaled **/
			/*this.pruningAlgo = new DepthLimitedPEP(0.4);
			  this.pruningAlgo.gatherTrainingStats(this, examples, random);
			  // the depth limited PEP implementation
			  this.pruningAlgo.pruneTree(this);
			  this.pruningAlgo.deleteTrainingStats(this);
			  this.pruningAlgo = null ;*/
		}
	}
	...
	{
		if (root == null) throw new RuntimeException("Trying to write a dot file "
			        + "for a null tree!");
	...
	{
		System.err.println("--- DecisionTree.show()");
