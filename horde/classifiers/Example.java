...
public class Example implements java.io.Serializable, Cloneable
{
	...
	// this is only set if the Example is used as a "continuation example"
	...
	/**
	 * Returns true if all the examples have identical value arrays,
	 * If the examples array is empty, throws an exception.
	 */
	...
	/**
	 * Returns true if the examples have identical classes,
	 * If the examples array is empty, throws an exception.
	 */
